...
const Booking = () => {
  ...
  const fetchSlotDetails = async () => {
    try {
      const response = await axios.get(`https://cricket-turf-booking-production.up.railway.app/api/slots/${slotId}`);
  ...
  const handlePayment = async () => {
    try {
      ...
      const { data: order } = await axios.post(
        'https://cricket-turf-booking-production.up.railway.app/api/payments/create-order',
        { amount: slot.price }
      );
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          const { data } = await axios.post(
            'https://cricket-turf-booking-production.up.railway.app/api/payments/verify',
            {
